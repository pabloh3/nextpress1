...
export default function PostPageComponent({ post, site }: PostPageProps) {
  if (!post) {
    return (
        ...
        <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div 
            ...
            dangerouslySetInnerHTML={{ 
              __html: parseContent(post.content) 
            }}
          />

          {post.meta && Object.keys(post.meta).length > 0 && (
            <div className="mt-12 pt-8 border-t border-gray-200">
              <h3 className="text-lg font-semibold text-gray-900 mb-4">Post Meta</h3>
