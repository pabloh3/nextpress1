...
let categories = [
  { id: 'basic', name: 'Basic', blocks: allBlocks.filter((b: any) => b.category === 'basic') },
  { id: 'media', name: 'Media', blocks: allBlocks.filter((b: any) => b.category === 'media') },
  { id: 'layout', name: 'Layout', blocks: allBlocks.filter((b: any) => b.category === 'layout') },
  { id: 'advanced', name: 'Advanced', blocks: allBlocks.filter((b: any) => b.category === 'advanced') },
      ...
      {categories.map((category) => {
        ...
        return (
          <div key={category.id}>
            ...
            <Droppable droppableId={`block-library-${category.id}`} isDropDisabled={true}>
              {(provided) => (
                <div
