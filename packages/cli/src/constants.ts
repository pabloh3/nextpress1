/** Default on-disk install location for the published CLI. */
...
/** Default Docker Hub tag for `husseinkizz/nextpress` when `--version` is omitted. */
...
/**
	 * Canonical compose spec for installs when not using env/cwd.
