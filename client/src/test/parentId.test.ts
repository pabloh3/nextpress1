...
const makeBlock = (id: string, children?: BlockConfig[]): BlockConfig => ({
  ...
  content: children !== undefined ? { kind: 'structured', data: {} } : { kind: 'text', value: '' },
      ...
      const blocks: BlockConfig[] = [
        {
          ...
          content: { kind: 'structured', data: {} },
          children: [
            { id: 'child1', name: 'core/text', type: 'block', parentId: 'container1', content: { kind: 'text', value: '' } }
          ]
        },
        {
          id: 'container2',
          ...
          content: { kind: 'structured', data: {} },
          children: [
            { id: 'child2', name: 'core/text', type: 'block', parentId: 'container2', content: { kind: 'text', value: '' } }
          ]
        }
      ];
